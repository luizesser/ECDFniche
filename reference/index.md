...
- [`create_distance_suitability_plot()`](https://luizesser.github.io/ECDFniche/reference/create_distance_suitability_plot.md)
  : Create distance–suitability plot
- [`ecdf_compare_niche()`](https://luizesser.github.io/ECDFniche/reference/ecdf_compare_niche.md)
  : Simulations and analyses of Mahalanobis distance-based habitat
  suitability
